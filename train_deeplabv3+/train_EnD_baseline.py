...
NUM_CLASSES = 19
NUM_STEPS = 100001
SAVE_PRED_EVERY = 1000 # debug to 10
WARM_UP = 0
INPUT_SIZE = '2048, 1024' #?? original: 1024, 512 (no resize now)
GT_SIZE = '2048,1024'
CROP_SIZE = '512,256'
SET = 'average_distilled' # for EnD / EnD2
NORM_STYLE = 'bn' # or in
AUTOAUG = False
...
SNAPSHOT_DIR = './snapshots_EnD_new_'
LOG_DIR = './log'
...
def main():
    ...
    for i_iter in range(args.num_steps):
        ...
        with Timer("Elapsed time in update: %f"):
            loss_seg = Trainer.gen_update(images, labels, i_iter, args.temperature)
        ...
        if i_iter % args.save_pred_every == 0 and i_iter != 0:
            ...
            print('mIoU: ', round(np.nanmean(mIoUs)*100, 2), int(i_iter/args.save_pred_every))
